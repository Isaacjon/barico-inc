...
export const Navbar = () => {
  ...
  return (
    <div className="md:bg-black/0 fixed z-50 w-full transition-all duration-300"
      style={{ backgroundColor: `${true ? '#ffffffcc' : ''}`, boxShadow: "0 8px 11px rgba(0, 0, 0, 0.04)" }}
    ...
    >
      <nav className="container relative flex justify-between items-center min-h-[80px] md:max-h-[80px]">
        ...
        <div className="absolute max-w-[152px] w-[10vw] min-w-[82px] z-10">
          ...
          <h1 className="text-sm text-black whitespace-nowrap font-bold">BARICHEM INC.</h1>
