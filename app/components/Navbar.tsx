    ...
    <div className="relative w-full max-w-[100vw]">
      ...
      >
        <nav className="max-w-screen-2xl mx-auto px-4 relative flex justify-between items-center min-h-[80px] md:max-h-[80px]">
          ...
          <ul
            className={`transition-all duration-300 absolute top-0 left-0 right-0 md:translate-y-0  w-full flex-wrap flex flex-col md:flex-row  gap-8 md:gap-y-0 pt-24 px-[16px] md:px-[30px] md:pt-0  md:static h-screen md:h-auto md:justify-center  ${burger ? ' justify-start -translate-y-[0px] -z-10 bg-black/80 before' : '-translate-y-full '} 
            `}>
