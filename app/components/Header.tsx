  ...
  return (
    <div id='main' className='header-bg-mobile sm:header-bg relative sm:bg-left-top md:bg-center pt-[80px] min-h-screen grid place-content-center'>
      <div className="container py-[40px] pt-[55px]h-full">
        {/* subtitle */}
        <h2 className='font-[family-name:var(--font-poppins)] text-2xl text-center md:text-6xl 2xl:text-7xl !leading-[150%] font-bold'>
        ПРОИЗВОДСТВО <br />
        УГЛЕКИСЛОГО БАРИЯ
        </h2>
        
        <hr className="border-2 max-w-[50%] m-auto my-4"/>
        
        <div className="flex flex-col items-center justify-center max-w-min m-auto">
        {/* title */}
        <h1 className='font-russo text-xl text-center flex justify-center gap-2 '>
        ...
        <div className='relative w-full'>
          ...
          <p className='pl-4 md:text-[30px] font-medium w-full md:whitespace-nowrap'>
